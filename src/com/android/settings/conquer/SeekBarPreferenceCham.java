...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String CONQUERONS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, CONQUERONS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, CONQUERONS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(CONQUERONS, "interval");
            if(newInterval != null)
